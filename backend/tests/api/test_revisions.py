...
@pytest.mark.asyncio
async def test_page_revisions_workflow(client: AsyncClient) -> None:
    ...
    space_resp = await client.post(
        "/api/v1/spaces",
        json={"name": "Revision Space", "key": "REVSPACE", "description": "Testing revisions"},
        cookies=cookies,
    )
    ...
    rev_list_resp = await client.get(f"/api/v1/spaces/REVSPACE/pages/{slug}/revisions", cookies=cookies)
    ...
    update_resp = await client.patch(
        f"/api/v1/spaces/REVSPACE/pages/{slug}",
    ...
    rev_list_resp2 = await client.get(f"/api/v1/spaces/REVSPACE/pages/{slug}/revisions", cookies=cookies)
    ...
    diff_resp = await client.get(
        f"/api/v1/spaces/REVSPACE/pages/{slug}/revisions/diff?from_version=1&to_version=2",
        cookies=cookies,
    )
    ...
    restore_resp = await client.post(
        f"/api/v1/spaces/REVSPACE/pages/{slug}/revisions/1/restore",
        cookies=cookies,
    )
    ...
    rev_list_resp3 = await client.get(f"/api/v1/spaces/REVSPACE/pages/{slug}/revisions", cookies=cookies)
