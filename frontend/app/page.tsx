  ...
  return (
    <AppShell fullWidth siteName={siteName} user={user}>
      <div className="space-y-8">
        {/* Header Orientation Section (Clean Wiki Workspace style) */}
        <section className="border-border bg-surface rounded-lg border p-6 sm:p-7">
          <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
            <div className="max-w-2xl">
              <p className="text-primary mb-1.5 flex items-center gap-2 text-xs font-semibold uppercase tracking-wide">
        ...
        <section aria-labelledby="getting-started-heading">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <Link
              href="/spaces"
              className="border-border bg-surface group hover:border-border-strong hover:bg-surface-hover focus-visible:ring-ring rounded-lg border p-5 transition-[border-color,background-color] duration-150 focus-visible:ring-2 focus-visible:outline-none"
            >
              <span className="bg-primary-subtle text-primary mb-3.5 flex size-9 items-center justify-center rounded-md">
            ...
            <Link
              ...
              className="border-border bg-surface group hover:border-border-strong hover:bg-surface-hover focus-visible:ring-ring rounded-lg border p-5 transition-[border-color,background-color] duration-150 focus-visible:ring-2 focus-visible:outline-none"
            >
              <span className="bg-info-bg text-info mb-3.5 flex size-9 items-center justify-center rounded-md">
            ...
            <Link
              ...
              className="border-border bg-surface group hover:border-border-strong hover:bg-surface-hover focus-visible:ring-ring rounded-lg border p-5 transition-[border-color,background-color] duration-150 focus-visible:ring-2 focus-visible:outline-none"
            >
              <span className="bg-warning-bg text-warning mb-3.5 flex size-9 items-center justify-center rounded-md">
